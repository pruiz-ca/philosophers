...
/*   Updated: 2021/08/13 20:11:27 by pruiz-ca         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_filldata(t_data *data)
{
	...
	data->fork = sem_open("sem_forks", O_CREAT, 0660, data->n_philo);
	data->msg = sem_open("sem_msg", O_CREAT, 0660, 1);
	data->meal = sem_open("sem_meal", O_CREAT, 0660, 1);
}
